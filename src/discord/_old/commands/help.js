...
const EMBED = new EmbedBuilder()
	.setTitle('Help')
	.setDescription(
		"Hello! I'm MrKonqi! I monitor this server and provide assistance to the people here! Down below is a list of my commands. If you have any questions about my functionality, you can ping one of the mods in here!",
	)
	.addFields([
		{
